...
<body class="bg-white">
    <div>
        <div id="navbar" class="h-28 bg-black grid-cols-1 flex justify-center items-center">
            <div class=""><input type="text" placeholder="Procure seu produto aqui"
                    class="input w-80 max-w-sm bg-white" /></div>
        </div>
        <div id="categorias" class="min-w-full h-28 bg-orange-500 flex justify-center items-center">
            <div>
                <a href="#bicicleta"><img
                        ...
                        src="images/bicicleta-sem-fundo.png" alt="" /></a>
            </div>
            <div>
                <a href="#componentes"><img
                        ...
                        src="images/componentes-sem-fundo.png" alt="" /></a>
            </div>
            <div>
                <a href="#ferramentas"><img
                        ...
                        src="images/ferramentas-sem-fundo.png" alt="" /></a>
            </div>
            <div>
                <a href="#mobiletes"><img
                        class="max-h-24 px-6 pt-4 hover:bg-orange-600 active:bg-orange-700 focus:outline-none focus:ring focus:ring-orange-300"
                        src="images/mobiletes-sem-fundo.png" alt="" /></a>
            </div>
            <div>
                <a href="#vestuario"><img
                        class="max-h-24 px-6 pt-4 hover:bg-orange-600 active:bg-orange-700 focus:outline-none focus:ring focus:ring-orange-300"
                        src="images/vestuari-sem-fundo.png" alt="" /></a>
            </div>
        </div>
        <div class="carousel w-full">
            <div id="slide1" class="carousel-item relative w-full">
                <img src="images/painel-1-mobilete-teste.png" class="w-full" />
            ...
            <div id="slide2" class="carousel-item relative w-full">
                <img src="images/painel-2-kitferramentas-teste.png" class="w-full" />
